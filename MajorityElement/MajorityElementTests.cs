...
namespace MajorityElement
{
    ...
    {
        [TestCase("A", new long[] { 2 }, 2)]
        [TestCase("B", new long[] { 2, 1 }, 0)]
        [TestCase("C", new long[] { 2, 2 }, 2)]
        [TestCase("D0", new long[] { 2, 2, 2 }, 2)]
        [TestCase("D1", new long[] { 2, 2, 3 }, 2)]
        ...
        [TestCase("E4", new long[] { 0, 2, 2, 2 }, 2)]
        [TestCase("E5", new long[] { 2, 2, 2, 0 }, 2)]
        [TestCase("E6", new long[] { 2, 2, 2, 2 }, 2)]
        [TestCase("F", new long[] { 2, 2, 2, 3, 9, }, 2)]
        [TestCase("G", new long[] { 1, 2, 3, 4, 5, 6 }, 0)]
        [TestCase("H", new long[] { 1, 2, 2, 2, 3 }, 2)]
        [TestCase("I", new long[] { 1, 1, 2, 2, 2 }, 2)]
        [TestCase("J", new long[] { 1, 1, 2, 2, 2, 2, 2, 2, 3, 3 }, 2)]
