...
namespace BinarySearch
{
    ...
    class BinarySearchTests
    {
        ...
        //[TestCase(new long[] { 2, 13, 87 }, new long[] { 1, 87 }, "0")]
        ...
        {
            var f0 = new Launcher();
            f0.BinarySearch(data, searchTerms).ShouldBe(expected);

            Should.CompleteIn(
            () => f0.BinarySearch(data, searchTerms), TimeSpan.FromMilliseconds(3000));
